...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_binop','PruebaSemantico.py',35),
  ('expression -> expression MINUS term','expression',3,'p_expression_binop','PruebaSemantico.py',36),
  ('expression -> term','expression',1,'p_expression_term','PruebaSemantico.py',40),
  ('term -> term TIMES factor','term',3,'p_term_binop','PruebaSemantico.py',44),
  ('term -> term DIVIDE factor','term',3,'p_term_binop','PruebaSemantico.py',45),
  ('term -> factor','term',1,'p_term_factor','PruebaSemantico.py',49),
  ('factor -> NUMBER','factor',1,'p_factor_number','PruebaSemantico.py',53),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','PruebaSemantico.py',57),
]
